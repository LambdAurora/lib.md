...
const INLINE_HTML_IGNORE_TAG = [ "iframe", "noembed", "noframes", "plaintext", "script", "style", "textarea", "title", "xmp" ];
                ...
                case "list_unordered":
                    ...
                    raw_list.forEach(raw_entry => {
                        ...
                        if (level === 0) {
                            ...
                            list.push(new md.ListEntry(this.parse_blocks(raw_entry, options), [], checked));
                            ...
                            parent_list.push(new md.ListEntry(this.parse_blocks(raw_entry, options), [], checked));
